...
#print(pd.read_sql_query("SELECT id, pdbID, group_concat(residues) FROM example GROUP BY pdbID", con))
print(pd.read_sql_query("SELECT id, group_concat(residues) FROM example GROUP BY pdbID", con))
